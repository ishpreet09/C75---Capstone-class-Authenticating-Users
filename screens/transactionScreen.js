...
import { Text, View, TouchableOpacity, TextInput,ToastAndroid, Image, StyleSheet, KeyboardAvoidingView} from 'react-native';
...
export default class TransactionScreen extends React.Component {
  ...
  handleTransaction = async()=>{
    ...
    if(!transactionType){
      ToastAndroid.show("The book isn't available",ToastAndroid.SHORT);
      this.setState({
        scannedBookId:'',
        scannedStudentId:''
      })
